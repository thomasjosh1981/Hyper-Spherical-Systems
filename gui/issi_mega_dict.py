...
ISSI_WORD_DICT: List[Tuple[str, str, bool]] = []
for idx, word in enumerate(UNIQUE_TOP_WORDS[:700]):
    code = f"§W{idx:03d}"
    ISSI_WORD_DICT.append((code, word, True))

ISSI_DICT = ISSI_WORD_DICT
...
class HierarchicalSymbolCollapser:
    """Collapses adjacent pairs of ISSI codes (§W001§W002 -> §S001) into 2nd-level Super-Symbols."""
