...
class WelcomePage(QtWidgets.QWizardPage):
    def __init__(self) -> None:
        super().__init__()
        self.setTitle("Welcome to Project Pirate Llama")
        ...
        text = QtWidgets.QLabel(
            ...
            "<b>Project Pirate Llama</b> engine. We will:</p>"
            "<ol>"
...
class EncryptionPage(QtWidgets.QWizardPage):
    ...
    def _gen(self) -> None:
        ...
        self._fpr = f"PIRATE-KEY-{words}-{digest[8:16].upper()}-{digest[16:24].upper()}"
