...
SCRIPT_TABLES = {
    ...
    'greek': {
        ...
        'K':'Λ','L':'Μ','M':'Ν','N':'Ξ','O':'Ο','P':'Π','Q':'Ρ','R':'Σ','S':'Υ','T':'Τ',
        'U':'Φ','V':'Χ','W':'Ψ','X':'Ω','Y':'α','Z':'β','0':'γ','1':'δ','2':'ε','3':'ζ',
        '4':'η','5':'θ','6':'ι','7':'κ','8':'λ','9':'μ','{':'⟨','}':'⟩','[':'⟦',']':'⟧',
        '(': '⟮',')':'⟯','<':'«','>':'»','=':'≡',';':'·','_':'―','/':'⁄','~':'☉',' ':'•'
    },
    'sanskrit': {
        'A':'अ','B':'ब','C':'क','D':'द','E':'ए','F':'फ','G':'ग','H':'ह','I':'इ','J':'ज',
        'K':'ख','L':'ल','M':'म','N':'न','O':'ओ','P':'प','Q':'घ','R':'र','S':'स','T':'त',
        'U':'उ','V':'व','W':'श','X':'ष','Y':'य','Z':'ध','0':'०','1':'१','2':'२','3':'३',
        '4':'४','5':'५','6':'६','7':'७','8':'८','9':'९','{':'ᳮ','}':'ᳯ','[':'ᳰ',']':'ᳱ',
        '(': 'ᳲ',')':'ᳳ','<':'‹','>':'›','=':'॥',';':'।','_':'्','/':'ॽ','~':'॰',' ':'⁞'
    },
    'hieroglyph': {
        'A':'𓂝','B':'𓃀','C':'𓎡','D':'𓂧','E':'𓇋','F':'𓆑','G':'𓎼','H':'𓉔','I':'𓇌','J':'𓆓',
        'K':'𓐍','L':'𓃭','M':'𓅓','N':'𓈖','O':'𓍯','P':'𓊪','Q':'𓏘','R':'𓂋','S':'𓋴','T':'𓏏',
        'U':'𓅱','V':'𓆗','W':'𓅷','X':'𓊃','Y':'𓇠','Z':'𓈎','0':'𓏺','1':'𓏻','2':'𓏼','3':'𓏽',
        '4':'𓏾','5':'𓏿','6':'𓐀','7':'𓐁','8':'𓐂','9':'𓐃','{':'𓉐','}':'𓉑','[':'𓊖',']':'𓊗',
        '(': '𓋹',')':'𓍑','<':'𓂻','>':'𓂼','=':'𓊢',';':'𓏶','_':'𓏲','/':'𓐎','~':'𓇩',' ':'𓎱'
    },
    'cuneiform': {
        'A':'𒀀','B':'𒁀','C':'𒅗','D':'𒁕','E':'𒂊','F':'𒉿','G':'𒂵','H':'𒄩','I':'𒄿','J':'𒅀',
        'K':'𒆕','L':'𒆷','M':'𒈠','N':'𒈾','O':'𒌋','P':'𒉺','Q':'𒋡','R':'𒊏','S':'𒊓','T':'𒋫',
        'U':'𒌑','V':'𒊑','W':'𒊒','X':'𒀝','Y':'𒅋','Z':'𒍝','0':'𒐀','1':'𒐕','2':'𒐖','3':'𒐗',
        '4':'𒐘','5':'𒐙','6':'𒐚','7':'𒐛','8':'鬨','9':'𒑆','{':'⦕','}':'⦖','[':'⸂',']':'⸃',
        '(': '⸄',')':'⸅','<':'◄','>':'►','=':'𒀸',';':'𒑱','_':'ـ','/':'𒑰','~':'𒑲',' ':'𒑴'
    },
    'nordic': {
        'A':'ᚨ','B':'ᛒ','C':'ᚲ','D':'ᛞ','E':'ᛖ','F':'ᚠ','G':'ᚷ','H':'ᚺ','I':'ᛁ','J':'ᛃ',
        'K':'ᚴ','L':'ᛚ','M':'ᛗ','N':'ᚾ','O':'ᛟ','P':'ᛈ','Q':'ᛜ','R':'ᚱ','S':'ᛋ','T':'ᛏ',
        'U':'ᚢ','V':'ᚹ','W':'ᚦ','X':'ᛉ','Y':'ᛇ','Z':'ᛎ','0':'ᛦ','1':'ᛧ','2':'ᛨ','3':'ᛩ',
        '4':'ᛪ','5':'᛫','6':'᛬','7':'᛭','8':'ᛮ','9':'ᛯ','{':'ᛐ','}':'ᛑ','[':'ᛓ',']':'ᛔ',
        '(': 'ᛕ',')':'ᚽ','<':'ᛡ','>':'ᛢ','=':'ᛘ',';':'ᛙ','_':'ᛝ','/':'ᛛ','~':'ᛠ',' ':'ᛸ'
    }
}
